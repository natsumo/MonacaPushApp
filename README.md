...
### 共通
* Monaca会員登録
 * https://ja.monaca.io/より登録（無料）をお願いします
 ...
 * ②開発用証明書(.cer)・⑤プロビジョニングプロファイル・⑦開発用証明書(.p12)・⑧APNs用証明書(.p12)
...
## 参考
* ニフティクラウドmobile backend の[ドキュメント（クイックスタート）](http://mb.cloud.nifty.com/doc/current/introduction/quickstart_monaca.html)をご活用ください
